...
const latestConstraints = [
  ...
  "layers_role_check",
  "markup_pkey",
  "markup_photo_id_fkey",
  "markup_items_array_check",
  ...
  "photos_pkey",
  "photos_rating_check",
  "originals_shot_offset_min_check",
  "originals_size_check",
  "originals_kind_check",
  "originals_w_check",
  "originals_h_check",
  "originals_orientation_check",
  "originals_pkey",
  "originals_photo_id_fkey",
  "originals_photo_id_id_key",
  "originals_photo_id_kind_key",
  "photos_primary_original_fkey",
  "photos_w_check",
  "schema_version_pkey",
  "settings_pkey",
  "tags_photo_id_fkey",
  ...
  const missing = [
    ...
    ...missingNames(
      [
        ...
        "files_original_id_idx",
        "originals_photo_id_idx",
        ...
        "photos_flag_idx",
        "photos_label_idx",
        "originals_promoted_content_hash_idx",
        "photos_rating_idx",
        "photos_searchable_gin_idx",
        "originals_shot_id_idx",
        "originals_unpromoted_content_key_idx",
      ],
      indexes.rows,
    ),
